...
- (id)init
{
    ...
    if (self) {
        ...
        _deviceSize = [Env deviceSize];
        _screenSize = [[UIScreen mainScreen] bounds].size;
        _screenWidth = _screenSize.width;
        
        NSLog(@"_systemMajorVersion %ld, _deviceSize:%ld, _screenSize:(%.1f,%.1f)",_systemMajorVersion,_deviceSize,_screenSize.width,_screenSize.height);
    }
    return self;
}
